...
<style>
    ...
    .od-baloo{font-family:'Baloo 2',sans-serif;}
...
<div class="container{{ Auth::user()->role !== 'admin' ? ' pt-3 pb-4' : '-fluid' }}">

    @if (Auth::user()->role === 'admin')
        <div class="p-3 rounded mb-3" style="background-color: #FFD85C;">
            <h3 class="fw-bold mb-0" style="color: #2A324C;">Detail Pesanan</h3>
        </div>
    @else
        <h3 class="fw-bold mb-1" style="color: #2A324C;">Detail Pesanan</h3>
    @endif
